...
from friends.views import get_friends, send_friend_request, withdraw_friend_request, accept_friend_request, reject_friend_request, search_friends, requests_sent, requests_received
urlpatterns = [
