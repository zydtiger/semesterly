...
from friends.views import get_friends, remove_friend, send_friend_request, withdraw_friend_request, accept_friend_request, reject_friend_request, search_friends, get_requests_sent, get_requests_received
urlpatterns = [
...
path('friends/requests_received', get_requests_received, name="friend requests received"),
